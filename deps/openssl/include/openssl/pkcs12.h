...
DEPRECATEDIN_1_1_0(ASN1_TYPE *PKCS12_get_attr(const PKCS12_SAFEBAG *bag,
					      int attr_nid))
...
void PKCS12_get0_mac(const ASN1_OCTET_STRING **pmac, const X509_ALGOR **pmacalg,
		     ...
		     const ASN1_INTEGER **piter, const PKCS12 *p12);
...
unsigned char *PKCS12_pbe_crypt(const X509_ALGOR *algor, const char *pass,
				int passlen, const unsigned char *in, int inlen,
