...
#define d2i_DSAparams_fp(fp, x)                                              \
	(DSA *)ASN1_d2i_fp((char *(*)())DSA_new, (char *(*)())d2i_DSAparams, \
			   (fp), (unsigned char **)(x))
...
DEPRECATEDIN_1_2_0(int DSA_sign_setup(DSA *dsa, BN_CTX *ctx_in, BIGNUM **kinvp,
				      BIGNUM **rp))
...
/* Deprecated version */
DEPRECATEDIN_0_9_8(DSA *DSA_generate_parameters(
	int bits, unsigned char *seed, int seed_len, int *counter_ret,
	unsigned long *h_ret, void (*callback)(int, int, void *), void *cb_arg))
