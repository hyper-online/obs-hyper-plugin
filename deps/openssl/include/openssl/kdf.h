...
#define EVP_PKEY_CTX_set_tls1_prf_md(pctx, md)                                \
	EVP_PKEY_CTX_ctrl(pctx, -1, EVP_PKEY_OP_DERIVE, EVP_PKEY_CTRL_TLS_MD, \
			  0, (void *)(md))
...
#define EVP_PKEY_CTX_set_hkdf_md(pctx, md)                                     \
	EVP_PKEY_CTX_ctrl(pctx, -1, EVP_PKEY_OP_DERIVE, EVP_PKEY_CTRL_HKDF_MD, \
			  0, (void *)(md))
...
#define EVP_PKEY_CTX_set1_pbe_pass(pctx, pass, passlen)                     \
	EVP_PKEY_CTX_ctrl(pctx, -1, EVP_PKEY_OP_DERIVE, EVP_PKEY_CTRL_PASS, \
			  passlen, (void *)(pass))
