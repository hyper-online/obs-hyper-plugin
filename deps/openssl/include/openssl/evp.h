...
#define EVP_PKEY_assign_SIPHASH(pkey, shkey) \
	EVP_PKEY_assign((pkey), EVP_PKEY_SIPHASH, (char *)(shkey))
#endif

#ifndef OPENSSL_NO_POLY1305
#define EVP_PKEY_assign_POLY1305(pkey, polykey) \
	EVP_PKEY_assign((pkey), EVP_PKEY_POLY1305, (char *)(polykey))
#endif
...
int EVP_PKEY_set1_tls_encodedpoint(EVP_PKEY *pkey, const unsigned char *pt,
				   size_t ptlen);
...
void EVP_PKEY_asn1_set_public(EVP_PKEY_ASN1_METHOD *ameth,
			      ...
			      int (*pub_cmp)(const EVP_PKEY *a,
					     const EVP_PKEY *b),
			      int (*pub_print)(BIO *out, const EVP_PKEY *pkey,
...
#define EVP_PKEY_CTX_get_signature_md(ctx, pmd)                                \
	EVP_PKEY_CTX_ctrl(ctx, -1, EVP_PKEY_OP_TYPE_SIG, EVP_PKEY_CTRL_GET_MD, \
			  0, (void *)(pmd))
