...
int RAND_DRBG_instantiate(RAND_DRBG *drbg, const unsigned char *pers,
			  size_t perslen);
 ...
 */
int RAND_DRBG_reseed(RAND_DRBG *drbg, const unsigned char *adin, size_t adinlen,
...
typedef size_t (*RAND_DRBG_get_nonce_fn)(RAND_DRBG *drbg, unsigned char **pout,
					 ...
					 size_t max_len);
typedef void (*RAND_DRBG_cleanup_nonce_fn)(RAND_DRBG *drbg, unsigned char *out,
					   size_t outlen);
