...
typedef void CRYPTO_EX_new(void *parent, void *ptr, CRYPTO_EX_DATA *ad, int idx,
			   long argl, void *argp);
...
void CRYPTO_secure_clear_free(void *ptr, size_t num, const char *file,
			      int line);
 ...
 */
void CRYPTO_mem_debug_malloc(void *addr, size_t num, int flag, const char *file,
			     int line);
...
/* die if we have to */
ossl_noreturn void OPENSSL_die(const char *assertion, const char *file,
			       int line);
#if OPENSSL_API_COMPAT < 0x10100000L
...
#define OPENSSL_assert(e)                                                \
	(void)((e) ? 0                                                   \
		   : (OPENSSL_die("assertion failed: " #e, OPENSSL_FILE, \
				  OPENSSL_LINE),                         \
		      1))
