 ...
 *  \return 1 on success and 0 if an error occurred
 */
DEPRECATEDIN_1_2_0(int EC_POINT_set_affine_coordinates_GFp(
	const EC_GROUP *group, EC_POINT *p, const BIGNUM *x, const BIGNUM *y,
	BN_CTX *ctx))
 ...
 *  \return 1 on success and 0 if an error occurred
 */
DEPRECATEDIN_1_2_0(int EC_POINT_get_affine_coordinates_GFp(
	const EC_GROUP *group, const EC_POINT *p, BIGNUM *x, BIGNUM *y,
	BN_CTX *ctx))
 ...
 *  \return 1 on success and 0 if an error occurred
 */
DEPRECATEDIN_1_2_0(int EC_POINT_set_compressed_coordinates_GFp(
	const EC_GROUP *group, EC_POINT *p, const BIGNUM *x, int y_bit,
	BN_CTX *ctx))
#ifndef OPENSSL_NO_EC2M
/** Sets the affine coordinates of an EC_POINT. A synonym of
 *  EC_POINT_set_affine_coordinates
 ...
 *  \return 1 on success and 0 if an error occurred
 */
DEPRECATEDIN_1_2_0(int EC_POINT_set_affine_coordinates_GF2m(
	const EC_GROUP *group, EC_POINT *p, const BIGNUM *x, const BIGNUM *y,
	BN_CTX *ctx))
...
void EC_KEY_METHOD_get_init(
	const EC_KEY_METHOD *meth, int (**pinit)(EC_KEY *key),
...
void EC_KEY_METHOD_get_sign(
	...
	int (**psign)(int type, const unsigned char *dgst, int dlen,
		      unsigned char *sig, unsigned int *siglen,
		      const BIGNUM *kinv, const BIGNUM *r, EC_KEY *eckey),
	int (**psign_setup)(EC_KEY *eckey, BN_CTX *ctx_in, BIGNUM **kinvp,
			    BIGNUM **rp),
...
#define EVP_PKEY_CTX_set1_id(ctx, id, id_len)                              \
	EVP_PKEY_CTX_ctrl(ctx, -1, -1, EVP_PKEY_CTRL_SET1_ID, (int)id_len, \
			  (void *)(id))

#define EVP_PKEY_CTX_get1_id(ctx, id) \
	EVP_PKEY_CTX_ctrl(ctx, -1, -1, EVP_PKEY_CTRL_GET1_ID, 0, (void *)(id))

#define EVP_PKEY_CTX_get1_id_len(ctx, id_len)                        \
	EVP_PKEY_CTX_ctrl(ctx, -1, -1, EVP_PKEY_CTRL_GET1_ID_LEN, 0, \
			  (void *)(id_len))
