...
#define static_ASN1_ITEM_TEMPLATE_END(tname)                    \
	;                                                       \
	static_ASN1_ITEM_start(tname) ASN1_ITYPE_PRIMITIVE, -1, \
		&tname##_item_tt, 0, NULL, 0, #tname ASN1_ITEM_end(tname)
...
#define static_ASN1_SEQUENCE_END_name(stname, tname)                        \
	;                                                                   \
	static_ASN1_ITEM_start(tname) ASN1_ITYPE_SEQUENCE, V_ASN1_SEQUENCE, \
		tname##_seq_tt,                                             \
		sizeof(tname##_seq_tt) / sizeof(ASN1_TEMPLATE), NULL,       \
...
#define static_ASN1_NDEF_SEQUENCE_END(tname)                          \
	;                                                             \
	static_ASN1_ITEM_start(tname) ASN1_ITYPE_NDEF_SEQUENCE,       \
		V_ASN1_SEQUENCE, tname##_seq_tt,                      \
		sizeof(tname##_seq_tt) / sizeof(ASN1_TEMPLATE), NULL, \
		sizeof(tname), #tname ASN1_ITEM_end(tname)
...
#define static_ASN1_CHOICE_END_selector(stname, tname, selname)      \
	;                                                            \
	static_ASN1_ITEM_start(tname) ASN1_ITYPE_CHOICE,             \
		offsetof(stname, selname), tname##_ch_tt,            \
		sizeof(tname##_ch_tt) / sizeof(ASN1_TEMPLATE), NULL, \
		sizeof(stname), #stname ASN1_ITEM_end(tname)
...
#define ASN1_EMBED(stname, field, type) \
	ASN1_EX_TYPE(ASN1_TFLG_EMBED, 0, stname, field, type)
...
#define ASN1_OPT_EMBED(stname, field, type)                                  \
	ASN1_EX_TYPE(ASN1_TFLG_OPTIONAL | ASN1_TFLG_EMBED, 0, stname, field, \
		     type)
...
#define ASN1_IMP_OPT_EMBED(stname, field, type, tag) \
	ASN1_IMP_EX(stname, field, type, tag,        \
		    ASN1_TFLG_OPTIONAL | ASN1_TFLG_EMBED)
...
#define IMPLEMENT_STATIC_ASN1_ENCODE_FUNCTIONS(stname)                    \
	static stname *d2i_##stname(stname **a, const unsigned char **in, \
				    long len)                             \
	{                                                                 \
		return (stname *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, \
					       ASN1_ITEM_rptr(stname));   \
