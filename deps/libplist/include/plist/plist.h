...
/**
     ...
     */
PLIST_API_MSC void plist_array_insert_item(plist_t node, plist_t item,
					   uint32_t n);
...
/**
     ...
     *          to iterate.
     */
PLIST_API_MSC void plist_array_next_item(plist_t node, plist_array_iter iter,
					 plist_t *item);
...
/**
     ...
     */
PLIST_API_MSC void plist_dict_next_item(plist_t node, plist_dict_iter iter,
...
/**
     ...
     */
PLIST_API_MSC void plist_dict_set_item(plist_t node, const char *key,
				       plist_t item);
...
PLIST_API_MSC void plist_dict_insert_item(plist_t node, const char *key,
					  plist_t item);
...
/**
     ...
     * @param length the length of the buffer
     */
PLIST_API_MSC void plist_get_data_val(plist_t node, char **val,
				      uint64_t *length);
...
/**
     ...
     */
PLIST_API_MSC void plist_get_date_val(plist_t node, int32_t *sec,
				      int32_t *usec);
...
/**
     ...
     * @param length the length of the buffer
     */
PLIST_API_MSC void plist_set_data_val(plist_t node, const char *val,
				      uint64_t length);
...
/**
     ...
     */
PLIST_API_MSC void plist_to_xml(plist_t plist, char **plist_xml,
				uint32_t *length);
...
/**
     ...
     * @param length a pointer to an uint32_t variable. Represents the length of the allocated buffer.
     */
PLIST_API_MSC void plist_to_bin(plist_t plist, char **plist_bin,
				uint32_t *length);
...
/**
     ...
     */
PLIST_API_MSC void plist_from_xml(const char *plist_xml, uint32_t length,
				  plist_t *plist);
...
/**
     ...
     * @param plist a pointer to the imported plist.
     */
PLIST_API_MSC void plist_from_bin(const char *plist_bin, uint32_t length,
				  plist_t *plist);
...
/**
     ...
     * @param plist a pointer to the imported plist.
     */
PLIST_API_MSC void plist_from_memory(const char *plist_data, uint32_t length,
				     plist_t *plist);
...
/**
     ...
     * @return the value to access.
     */
PLIST_API_MSC plist_t plist_access_pathv(plist_t plist, uint32_t length,
					 va_list v);
...
#define _PLIST_IS_TYPE(__plist, __plist_type) \
	(__plist && (plist_get_node_type(__plist) == PLIST_##__plist_type))
...
/**
     ...
     */
PLIST_API_MSC int plist_date_val_compare(plist_t datenode, int32_t cmpsec,
					 int32_t cmpusec);
...
/**
     ...
     *     or < 0 if the node's value is lexicographically less than cmpval.
     */
PLIST_API_MSC int plist_string_val_compare_with_size(plist_t strnode,
						     const char *cmpval,
						     size_t n);
...
/**
     ...
     *     or 0 if not.
     */
PLIST_API_MSC int plist_string_val_contains(plist_t strnode,
					    const char *substr);
...
/**
     ...
     *     or < 0 if the node's value is lexicographically less than cmpval.
     */
PLIST_API_MSC int plist_key_val_compare_with_size(plist_t keynode,
...
/**
     ...
     *     or < 0 if the node's value is lexicographically less than cmpval.
     */
PLIST_API_MSC int plist_data_val_compare(plist_t datanode,
...
/**
     ...
     *     or < 0 if the node's value is lexicographically less than cmpval.
     */
PLIST_API_MSC int plist_data_val_compare_with_size(plist_t datanode,
...
/**
     ...
     *     or 0 if not.
     */
PLIST_API_MSC int plist_data_val_contains(plist_t datanode,
					  const uint8_t *cmpval, size_t n);
