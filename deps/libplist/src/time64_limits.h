...
/* Max/min for mktime() */
static const struct tm SYSTEM_MKTIME_MAX = {7,
					    14,
					    19,
					    18,
					    0,
...
static const struct tm SYSTEM_MKTIME_MIN = {52,
					    45,
					    12,
					    13,
					    11,
...
/* Max/min for timegm() */
#ifdef HAVE_TIMEGM
static const struct tm SYSTEM_TIMEGM_MAX = {7,
					    14,
					    3,
					    19,
					    0,
...
static const struct tm SYSTEM_TIMEGM_MIN = {52,
					    45,
					    20,
					    13,
					    11,
