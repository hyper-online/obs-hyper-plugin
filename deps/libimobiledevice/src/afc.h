...
enum {
	...
	AFC_OP_WRITE_FILE_ATOM =
		0x0000000C,            /* WriteFileAtomic (tmp file+rename) */
	...
	/* iOS 6+ */
	AFC_OP_FILE_SET_IMMUTABLE_HINT =
		0x00000020, /* FileRefSetImmutableHint */
	AFC_OP_GET_SIZE_OF_PATH_CONTENTS =
		0x00000021, /* GetSizeOfPathContents */
	AFC_OP_REMOVE_PATH_AND_CONTENTS =
		0x00000022,           /* RemovePathAndContents */
	AFC_OP_DIR_OPEN = 0x00000023, /* DirectoryEnumeratorRefOpen */
	AFC_OP_DIR_OPEN_RESULT =
		0x00000024,            /* DirectoryEnumeratorRefOpenResult */
...
LIBIMOBILEDEVICE_API_MSC afc_error_t afc_client_new_with_service_client(
