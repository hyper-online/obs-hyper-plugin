...
typedef syslog_relay_client_private
	*syslog_relay_client_t; /**< The client handle. */
 ...
 */
LIBIMOBILEDEVICE_API_MSC syslog_relay_error_t syslog_relay_client_new(
 ...
 *     code otherwise.
 */
LIBIMOBILEDEVICE_API_MSC syslog_relay_error_t syslog_relay_client_start_service(
 ...
 *     client is NULL, or an SYSLOG_RELAY_E_* error code otherwise.
 */
LIBIMOBILEDEVICE_API_MSC syslog_relay_error_t
 ...
 *      error occurs or a syslog capture has already been started.
 */
LIBIMOBILEDEVICE_API_MSC syslog_relay_error_t syslog_relay_start_capture_raw(
 ...
 *      error occurs.
 */
LIBIMOBILEDEVICE_API_MSC syslog_relay_error_t syslog_relay_receive_with_timeout(
