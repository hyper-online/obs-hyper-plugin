...
#define NP_TRUSTED_HOST_ATTACHED \
...
#define NP_DISK_USAGE_CHANGED \
	"com.apple.mobile.lockdown.disk_usage_changed" /**< iOS 4.0+ */
 ...
 *   established.
 */
LIBIMOBILEDEVICE_API_MSC np_error_t
 ...
 *     code otherwise.
 */
LIBIMOBILEDEVICE_API_MSC np_error_t np_client_start_service(idevice_t device,
							    np_client_t *client,
							    const char *label);
 ...
 */
LIBIMOBILEDEVICE_API_MSC np_error_t
np_post_notification(np_client_t client, const char *notification);
 ...
 */
LIBIMOBILEDEVICE_API_MSC np_error_t np_set_notify_callback(
	np_client_t client, np_notify_cb_t notify_cb, void *userdata);
