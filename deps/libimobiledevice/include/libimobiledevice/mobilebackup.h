...
typedef mobilebackup_client_private
	*mobilebackup_client_t; /**< The client handle. */
 ...
 */
LIBIMOBILEDEVICE_API_MSC mobilebackup_error_t mobilebackup_client_new(
 ...
 *     code otherwise.
 */
LIBIMOBILEDEVICE_API_MSC mobilebackup_error_t mobilebackup_client_start_service(
 ...
 *     if client is NULL.
 */
LIBIMOBILEDEVICE_API_MSC mobilebackup_error_t
 ...
 */
LIBIMOBILEDEVICE_API_MSC mobilebackup_error_t mobilebackup_request_backup(
 ...
 */
LIBIMOBILEDEVICE_API_MSC mobilebackup_error_t mobilebackup_request_restore(
	mobilebackup_client_t client, plist_t backup_manifest,
