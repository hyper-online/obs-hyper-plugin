 ...
 */
LIBIMOBILEDEVICE_API_MSC restored_error_t restored_client_new(
 ...
 * @return RESTORE_E_SUCCESS on success, RESTORE_E_INVALID_ARG when client is NULL
 */
LIBIMOBILEDEVICE_API_MSC restored_error_t
 ...
 */
LIBIMOBILEDEVICE_API_MSC restored_error_t restored_start_restore(
...
restored_client_set_label(restored_client_t client, const char *label);
