 ...
 */
LIBIMOBILEDEVICE_API_MSC lockdownd_error_t lockdownd_client_new(
 ...
 */
LIBIMOBILEDEVICE_API_MSC lockdownd_error_t lockdownd_client_new_with_handshake(
	idevice_t device, lockdownd_client_t *client, const char *label);
 ...
 * @return LOCKDOWN_E_SUCCESS on success, LOCKDOWN_E_INVALID_ARG when client is NULL
 */
LIBIMOBILEDEVICE_API_MSC lockdownd_error_t
 ...
 * @return LOCKDOWN_E_SUCCESS on success, LOCKDOWN_E_INVALID_ARG when client is NULL
 */
LIBIMOBILEDEVICE_API_MSC lockdownd_error_t lockdownd_remove_value(
 ...
 */
LIBIMOBILEDEVICE_API_MSC lockdownd_error_t
lockdownd_start_service_with_escrow_bag(lockdownd_client_t client,
 ...
 */
LIBIMOBILEDEVICE_API_MSC lockdownd_error_t
lockdownd_send(lockdownd_client_t client, plist_t plist);
 ...
 *  LOCKDOWN_E_INVALID_HOST_ID if the device does not know the caller's host id
 */
LIBIMOBILEDEVICE_API_MSC lockdownd_error_t lockdownd_pair_with_options(
 ...
 *  LOCKDOWN_E_INVALID_HOST_ID if the device does not know the caller's host id
 */
LIBIMOBILEDEVICE_API_MSC lockdownd_error_t lockdownd_validate_pair(
	lockdownd_client_t client, lockdownd_pair_record_t pair_record);
 ...
 *  LOCKDOWN_E_INVALID_HOST_ID if the device does not know the caller's host id
 */
LIBIMOBILEDEVICE_API_MSC lockdownd_error_t lockdownd_unpair(
	lockdownd_client_t client, lockdownd_pair_record_t pair_record);
...
lockdownd_client_set_label(lockdownd_client_t client, const char *label);
 ...
 *  LOCKDOWN_E_PLIST_ERROR if the received plist is broken
 */
LIBIMOBILEDEVICE_API_MSC lockdownd_error_t lockdownd_get_sync_data_classes(
