...
typedef companion_proxy_client_private
	*companion_proxy_client_t; /**< The client handle. */

typedef void (*companion_proxy_device_event_cb_t)(plist_t event,
						  void *userdata);
 ...
 */
LIBIMOBILEDEVICE_API_MSC companion_proxy_error_t companion_proxy_client_new(
 ...
 *     code otherwise.
 */
LIBIMOBILEDEVICE_API_MSC companion_proxy_error_t
