...
typedef house_arrest_client_private
	*house_arrest_client_t; /**< The client handle. */
 ...
 */
LIBIMOBILEDEVICE_API_MSC house_arrest_error_t house_arrest_client_new(
 ...
 *     code otherwise.
 */
LIBIMOBILEDEVICE_API_MSC house_arrest_error_t house_arrest_client_start_service(
 ...
 *     client is NULL, or an HOUSE_ARREST_E_* error code otherwise.
 */
LIBIMOBILEDEVICE_API_MSC house_arrest_error_t
 ...
 *     or HOUSE_ARREST_E_CONN_FAILED if a connection error occurred.
 */
LIBIMOBILEDEVICE_API_MSC house_arrest_error_t house_arrest_send_command(
 ...
 */
LIBIMOBILEDEVICE_API_MSC afc_error_t afc_client_new_from_house_arrest_client(
