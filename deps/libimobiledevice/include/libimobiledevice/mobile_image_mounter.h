...
#define MOBILE_IMAGE_MOUNTER_SERVICE_NAME \
...
typedef mobile_image_mounter_client_private
	*mobile_image_mounter_client_t; /**< The client handle. */

/** callback for image upload */
typedef ssize_t (*mobile_image_mounter_upload_cb_t)(void *buffer, size_t length,
						    void *user_data);
 ...
 */
LIBIMOBILEDEVICE_API_MSC mobile_image_mounter_error_t mobile_image_mounter_new(
 ...
 *     code otherwise.
 */
LIBIMOBILEDEVICE_API_MSC mobile_image_mounter_error_t
