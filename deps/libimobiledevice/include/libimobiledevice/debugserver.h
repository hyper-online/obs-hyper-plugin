...
typedef debugserver_client_private
	*debugserver_client_t; /**< The client handle. */

typedef struct debugserver_command_private debugserver_command_private;
typedef debugserver_command_private
	*debugserver_command_t; /**< The command handle. */
 ...
 */
LIBIMOBILEDEVICE_API_MSC debugserver_error_t
 ...
 *     code otherwise.
 */
LIBIMOBILEDEVICE_API_MSC debugserver_error_t debugserver_client_start_service(
 ...
 */
LIBIMOBILEDEVICE_API_MSC debugserver_error_t debugserver_client_send_command(
 ...
 */
LIBIMOBILEDEVICE_API_MSC debugserver_error_t
debugserver_client_receive_response(debugserver_client_t client,
				    char **response, size_t *response_size);
...
debugserver_encode_string(const char *buffer, char **encoded_buffer,
 ...
 */
LIBIMOBILEDEVICE_API_MSC void
debugserver_decode_string(const char *encoded_buffer, size_t encoded_length,
			  char **buffer);
