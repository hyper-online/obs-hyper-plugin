...
#define SERVICE_CONSTRUCTOR(x) \
	(int32_t(*)(idevice_t, lockdownd_service_descriptor_t, void **))(x)
 ...
 */
LIBIMOBILEDEVICE_API_MSC service_error_t
 ...
 *     otherwise.
 */
LIBIMOBILEDEVICE_API_MSC service_error_t service_client_factory_start_service(
 ...
 */
LIBIMOBILEDEVICE_API_MSC service_error_t
service_client_free(service_client_t client);
 ...
 *      error occurs.
 */
LIBIMOBILEDEVICE_API_MSC service_error_t service_send(service_client_t client,
						      const char *data,
						      uint32_t size,
						      uint32_t *sent);
 ...
 *      error occurs.
 */
LIBIMOBILEDEVICE_API_MSC service_error_t service_receive(
	service_client_t client, char *data, uint32_t size, uint32_t *received);
 ...
 */
LIBIMOBILEDEVICE_API_MSC service_error_t
service_enable_ssl(service_client_t client);
 ...
 */
LIBIMOBILEDEVICE_API_MSC service_error_t
service_disable_ssl(service_client_t client);
