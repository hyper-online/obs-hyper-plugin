...
typedef diagnostics_relay_client_private
	*diagnostics_relay_client_t; /**< The client handle. */
 ...
 */
LIBIMOBILEDEVICE_API_MSC diagnostics_relay_error_t diagnostics_relay_client_new(
 ...
 *     code otherwise.
 */
LIBIMOBILEDEVICE_API_MSC diagnostics_relay_error_t
 ...
 *  request
 */
LIBIMOBILEDEVICE_API_MSC diagnostics_relay_error_t diagnostics_relay_restart(
 ...
 *  request
 */
LIBIMOBILEDEVICE_API_MSC diagnostics_relay_error_t diagnostics_relay_shutdown(
	diagnostics_relay_client_t client, diagnostics_relay_action_t flags);
