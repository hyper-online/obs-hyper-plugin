...
typedef mobilebackup2_client_private
	*mobilebackup2_client_t; /**< The client handle. */
 ...
 */
LIBIMOBILEDEVICE_API_MSC mobilebackup2_error_t mobilebackup2_client_new(
 ...
 *     code otherwise.
 */
LIBIMOBILEDEVICE_API_MSC mobilebackup2_error_t
mobilebackup2_client_start_service(idevice_t device,
				   mobilebackup2_client_t *client,
				   const char *label);
 ...
 */
LIBIMOBILEDEVICE_API_MSC mobilebackup2_error_t mobilebackup2_send_message(
 ...
 */
LIBIMOBILEDEVICE_API_MSC mobilebackup2_error_t mobilebackup2_receive_message(
 ...
 *     code otherwise.
 */
LIBIMOBILEDEVICE_API_MSC mobilebackup2_error_t mobilebackup2_version_exchange(
 ...
 */
LIBIMOBILEDEVICE_API_MSC mobilebackup2_error_t
mobilebackup2_send_status_response(mobilebackup2_client_t client,
				   int status_code, const char *status1,
				   plist_t status2);
