...
typedef void (*instproxy_status_cb_t)(plist_t command, plist_t status,
				      void *user_data);
 ...
 */
LIBIMOBILEDEVICE_API_MSC instproxy_error_t
 ...
 *         code otherwise.
 */
LIBIMOBILEDEVICE_API_MSC instproxy_error_t instproxy_client_start_service(
 ...
 *         an error occurred.
 */
LIBIMOBILEDEVICE_API_MSC instproxy_error_t instproxy_browse(
 ...
 *         an error occurred.
 */
LIBIMOBILEDEVICE_API_MSC instproxy_error_t instproxy_browse_with_callback(
 ...
 */
LIBIMOBILEDEVICE_API_MSC instproxy_error_t instproxy_install(
 ...
 *       handled inside the specified callback function.
 */
LIBIMOBILEDEVICE_API_MSC instproxy_error_t instproxy_upgrade(
	instproxy_client_t client, const char *pkg_path, plist_t client_options,
	instproxy_status_cb_t status_cb, void *user_data);
 ...
 *       handled inside the specified callback function.
 */
LIBIMOBILEDEVICE_API_MSC instproxy_error_t instproxy_uninstall(
 ...
 *         an error occurred.
 */
LIBIMOBILEDEVICE_API_MSC instproxy_error_t instproxy_lookup_archives(
	instproxy_client_t client, plist_t client_options, plist_t *result);
 ...
 *       handled inside the specified callback function.
 */
LIBIMOBILEDEVICE_API_MSC instproxy_error_t instproxy_archive(
	instproxy_client_t client, const char *appid, plist_t client_options,
	instproxy_status_cb_t status_cb, void *user_data);
 ...
 *       handled inside the specified callback function.
 */
LIBIMOBILEDEVICE_API_MSC instproxy_error_t instproxy_restore(
	instproxy_client_t client, const char *appid, plist_t client_options,
	instproxy_status_cb_t status_cb, void *user_data);
 ...
 *       handled inside the specified callback function.
 */
LIBIMOBILEDEVICE_API_MSC instproxy_error_t instproxy_remove_archive(
	instproxy_client_t client, const char *appid, plist_t client_options,
	instproxy_status_cb_t status_cb, void *user_data);
 ...
 *         an error occurred.
 */
LIBIMOBILEDEVICE_API_MSC instproxy_error_t instproxy_check_capabilities_match(
 ...
 */
LIBIMOBILEDEVICE_API_MSC void instproxy_command_get_name(plist_t command,
							 char **name);
 ...
 */
LIBIMOBILEDEVICE_API_MSC void instproxy_status_get_name(plist_t status,
							char **name);
 ...
 */
LIBIMOBILEDEVICE_API_MSC instproxy_error_t instproxy_status_get_error(
 ...
 */
LIBIMOBILEDEVICE_API_MSC void
instproxy_status_get_percent_complete(plist_t status, int *percent);
 ...
 */
LIBIMOBILEDEVICE_API_MSC void
instproxy_client_options_add(plist_t client_options, ...);
 ...
 */
LIBIMOBILEDEVICE_API_MSC void
instproxy_client_options_free(plist_t client_options);
