 ...
 */
LIBIMOBILEDEVICE_API_MSC heartbeat_error_t
 ...
 *     code otherwise.
 */
LIBIMOBILEDEVICE_API_MSC heartbeat_error_t heartbeat_client_start_service(
 ...
 */
LIBIMOBILEDEVICE_API_MSC heartbeat_error_t heartbeat_receive_with_timeout(
