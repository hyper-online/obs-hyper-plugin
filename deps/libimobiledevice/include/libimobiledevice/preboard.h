 ...
 */
LIBIMOBILEDEVICE_API_MSC preboard_error_t
 ...
 *     code otherwise.
 */
LIBIMOBILEDEVICE_API_MSC preboard_error_t preboard_client_start_service(
 ...
 */
LIBIMOBILEDEVICE_API_MSC preboard_error_t
preboard_send(preboard_client_t client, plist_t plist);
 ...
 */
LIBIMOBILEDEVICE_API_MSC preboard_error_t
preboard_receive(preboard_client_t client, plist_t *plist);
 ...
 *  or a PREBOARD_E_* error code on error.
 */
LIBIMOBILEDEVICE_API_MSC preboard_error_t preboard_receive_with_timeout(
