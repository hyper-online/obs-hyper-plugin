 ...
 */
LIBIMOBILEDEVICE_API_MSC sbservices_error_t
 ...
 *     code otherwise.
 */
LIBIMOBILEDEVICE_API_MSC sbservices_error_t sbservices_client_start_service(
 ...
 */
LIBIMOBILEDEVICE_API_MSC sbservices_error_t sbservices_get_icon_state(
 ...
 *     client or state is invalid, or an SBSERVICES_E_* error code otherwise.
 */
LIBIMOBILEDEVICE_API_MSC sbservices_error_t sbservices_get_interface_orientation(
	sbservices_client_t client,
