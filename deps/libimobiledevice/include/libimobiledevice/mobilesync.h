...
typedef mobilesync_anchors
	*mobilesync_anchors_t; /**< Anchors used by the device and computer. */
 ...
 * the device is newer.
 */
LIBIMOBILEDEVICE_API_MSC mobilesync_error_t
 ...
 *     code otherwise.
 */
LIBIMOBILEDEVICE_API_MSC mobilesync_error_t mobilesync_client_start_service(
 ...
 * sync request
 */
LIBIMOBILEDEVICE_API_MSC mobilesync_error_t mobilesync_start(
