...
enum usbmux_lookup_options {
	...
	DEVICE_LOOKUP_NETWORK =
		1 << 2, /**< include network devices during lookup */
	DEVICE_LOOKUP_PREFER_NETWORK =
		1
 ...
 */
USBMUXD_API_MSC int
usbmuxd_events_subscribe(usbmuxd_subscription_context_t *context,
 ...
 */
USBMUXD_API_MSC int
usbmuxd_events_unsubscribe(usbmuxd_subscription_context_t context);
 ...
 */
USBMUXD_API_MSC int usbmuxd_subscribe(usbmuxd_event_cb_t callback,
				      void *user_data);
 ...
 */
USBMUXD_API_MSC int
usbmuxd_get_device_list(usbmuxd_device_info_t **device_list);
 ...
 */
USBMUXD_API_MSC int
usbmuxd_device_list_free(usbmuxd_device_info_t **device_list);
 ...
 */
USBMUXD_API_MSC int usbmuxd_get_device_by_udid(const char *udid,
					       usbmuxd_device_info_t *device);
 ...
 *    or a negative value on error.
 */
USBMUXD_API_MSC int usbmuxd_get_device(const char *udid,
				       usbmuxd_device_info_t *device,
 ...
 *    value on error.
 */
USBMUXD_API_MSC int usbmuxd_connect(const uint32_t handle,
 ...
 */
USBMUXD_API_MSC int usbmuxd_send(int sfd, const char *data, uint32_t len,
				 uint32_t *sent_bytes);
 ...
 * @return 0 on success, a negative errno value otherwise.
 */
USBMUXD_API_MSC int usbmuxd_recv_timeout(int sfd, char *data, uint32_t len,
					 uint32_t *recv_bytes,
 ...
 * @return 0 on success, a negative errno value otherwise.
 */
USBMUXD_API_MSC int usbmuxd_recv(int sfd, char *data, uint32_t len,
				 uint32_t *recv_bytes);
 ...
 */
USBMUXD_API_MSC int usbmuxd_read_pair_record(const char *record_id,
					     char **record_data,
 ...
 * @return 0 on success, a negative error value otherwise.
 */
USBMUXD_API_MSC int usbmuxd_save_pair_record(const char *record_id,
 ...
 * @return 0 on success, a negative error value otherwise.
 */
USBMUXD_API_MSC int usbmuxd_save_pair_record_with_device_id(
	const char *record_id, uint32_t device_id, const char *record_data,
	uint32_t record_size);
